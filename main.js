function savename() 
{
    docname = document.getElementById("document_name_input").value;
    document.getElementById("document_name_label").innerHTML = docname;
    document.getElementById("document_name_input").value = " ";
}
...
function backgroundcolor_save()
{
    ...
    document.getElementById("bgcolor_save").style.color = "white";
}
...
function voicetype()
{
    if (window.hasOwnProperty('webkitSpeechRecognition')) {
        ...
        recognition.onresult = function(e) {
          document.getElementById("write_area").value
                                   = document.getElementById("write_area").value + " " + e.results[0][0].transcript;
          recognition.stop();
...
{
    document.getElementById("write_area").style.letterSpacing = document.getElementById("enter_spacingL").value;
}